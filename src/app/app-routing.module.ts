...
const routes: Routes = [
  ...
  { path: "verificacionListados", canActivate: [UserGuard], component: VerificacionListadosComponent },
  { path: "eliminarDatos", canActivate: [UserGuard], component: EliminarDatosComponent },
