...
export class FormService {
  ...
  finalizar(tintoformoalt, idprod, pe, ppp, ppv, resi, pig, pr, array, usuario, solv, info2, info3) {
    let data = { tintoformoalt, idprod, pe, ppp, ppv, resi, pig, pr, array, usuario, solv, info2, info3 };
