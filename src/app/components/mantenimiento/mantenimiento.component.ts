...
export class MantenimientoComponent implements OnInit {
  ...
  enviarMant() {
    ...
    let bimestre = this.sumarDias(Hoy, 60);
    let dosmeses = bimestre.toISOString().split('T')[0];
    ...
    if (this.equipo == 'ELE') {
      ...
      } else if (this.equipo == 'ELE' && this.nroequipo.includes('Tijera', 0)) {
        this.proxrevision = dosmeses;
      } else {
        this.proxrevision = tresMeses;
      }
    }
 ...
 días es negativo restará los días*/
  sumarDias(date: Date, days: number): Date {
